...
export const rules: Rule[] = [
  ...
  // Keyboard flows are speed tools, so animation should never tax them.
  {
    ...
    do: "Shortcut response is immediate",
  ...
  // Easing rules define the feel before component-specific tuning begins.
  {
    ...
    dont: "ease-in on dropdown entry",
    tags: ["Easing", "Polish"],
  },
  {
    category: "motion",
  ...
  // Spatial rules should describe where anchored UI comes from and returns.
  {
    ...
    do: "transform-origin from trigger",
    dont: "Popover scales from center",
    tags: ["Popovers", "Spatial"],
  },
  {
    category: "motion",
    ...
    do: "Skip delay after first tooltip",
  ...
  // Interruptible UI should retarget smoothly under rapid user input.
  {
    ...
    do: "transition transform 200ms",
    dont: "Keyframe for rapid toggles",
    tags: ["Interruptible", "CSS"],
  },
  {
    category: "motion",
    ...
    do: "@starting-style opacity + transform",
    dont: "useEffect just to trigger entry",
    tags: ["Entry", "CSS"],
  },
  {
    category: "motion",
  ...
  },
  {
    ...
    dont: "Lose drag outside bounds",
    tags: ["Gestures", "Pointer"],
  },
  {
    category: "motion",
    ...
    do: "CSS transition for tab motion",
    dont: "JS animation for static timing",
    tags: ["Performance", "CSS"],
  },
  {
    category: "motion",
  ...
  },
  {
    ...
    dont: "Long cascade before usable UI",
    tags: ["Stagger", "Timing"],
  },
  {
    category: "motion",
