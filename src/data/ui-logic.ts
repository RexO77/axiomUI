...
export const rules: Rule[] = [
  ...
  },
  {
    ...
    id: "typo-6",
    desc: "To make secondary text less important, lighten the color (slate-500) rather than shrinking the size below 12px.",
    do: "Text-slate-500 (14px)",
  ...
  },
  {
    ...
    title: "Border Colors",
    id: "color-5",
    desc: "Borders should be subtle. If your text is slate-900, your borders should be slate-200.",
    do: "Border-slate-200",
    dont: "Border-slate-400 (Too heavy)",
    tags: ["Subtlety"],
  },
  {
    category: "color",
    ...
    do: "Border-slate-300 for inputs/buttons",
    dont: "Border-slate-100",
    tags: ["Accessibility"],
  },
  {
    category: "components",
...
export function buildDeepDive(rule: Rule): DeepDiveSection[] {
  return [
    ...
    },
    {
      ...
      content:
        "This decision protects clarity and scanning speed. It reduces cognitive load and preserves a predictable visual rhythm.",
    },
    {
      type: "list",
